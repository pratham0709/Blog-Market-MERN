...
const PostDetails = () => {
  ...
  const handleDeletePost = async () => {
    ...
    try {
      const res = await axios.delete("https://blog-ska7.onrender.com/api/posts/" + postId, { withCredentials: true })
      console.log(res.data)
      navigate("/")
  ...
  const fetchPostComments = async () => {
    setLoader(true)
    try {
      const res = await axios.get("https://blog-ska7.onrender.com/api/comments/post/" + postId)
  ...
  const postComment = async (e) => {
    e.preventDefault()
    try {
      const res = await axios.post("https://blog-ska7.onrender.com/api/comments/create",
